...
camp: syntactic
spans_camps: []
one_liner: "No Effort Required, Done. Replaces every operator with an English keyword on the bet that LLM tokenisers spend fewer tokens on words than on symbols. Built-in MCP client and LLM call primitives."
url: https://www.nerd-lang.org
repo: Nerd-Lang/nerd-lang-core
paper: null
author: Guru Sattanathan
implementation_language: C
compilation_target: LLVM IR (then native via clang)
license: Apache-2.0
...
crossrefs:
  - slug: magpie
    name: Magpie
    camp: syntactic
    relation: "Same diagnosis — strip ambiguity at the surface — opposite mechanism. Magpie surfaces SSA with %-prefixed names and one canonical operation per concept; NERD strips the operators and accepts a larger surface for shorter tokens."
  - slug: zero
    name: Zero
    camp: verification
    relation: "Cross-camp foil. Zero also leans on keywords and 'one obvious way' but pairs that with a type checker and a structured-JSON CLI; NERD ships neither."
  - slug: x07
    name: X07
    camp: syntactic
    relation: "Same camp, most extreme contrast. X07 walks past textual syntax to JSON ASTs; NERD keeps the text and economises the tokens inside it."
---
