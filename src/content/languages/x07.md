...
camp: syntactic
spans_camps: []
one_liner: "Eliminates text syntax. Programs are canonical JSON ASTs (x07AST); edits are RFC 6902 JSON Patch operations; diagnostics ship as stable JSON with quickfixes the toolchain applies deterministically."
url: https://x07lang.org
repo: x07lang/x07
paper: null
author: Author unknown
implementation_language: Rust
compilation_target: Native (via C codegen); WebAssembly
...
crossrefs:
  - slug: magpie
    name: Magpie
    camp: syntactic
    relation: "Same-camp cousin pointing the same way. Magpie surfaces SSA but keeps source text; X07 walks past text and treats the AST itself as the canonical artefact. Same direction, further along the axis."
  - slug: sever
    name: Sever
    camp: syntactic
    relation: "Both push the surface as far from human authoring as the camp allows; Sever crams meaning into single characters, X07 abandons characters as the unit altogether."
  - slug: nerd
    name: NERD
    camp: syntactic
    relation: "Opposite end of the same camp. NERD keeps text and economises tokens inside it; X07 declares text a lossy intermediate and edits the tree directly."
---
