...
one_liner: "Mandatory shadow test blocks on every function. The proved core (NanoCore) has 193 Coq theorems with zero axioms. Multi-target codegen across C, WebAssembly, LLVM IR, PTX, and RISC-V."
url: https://jordanhubbard.github.io/nanolang
repo: jordanhubbard/nanolang
paper: null
author: Jordan Hubbard
implementation_language: C
compilation_target: C (default), WebAssembly, LLVM IR, PTX, RISC-V
license: Apache-2.0
maturity: working_compiler
date_appeared: 2025-09
agent_tooling:
  - AGENTS.md
  - CLAUDE.md
...
crossrefs:
  - slug: vera
    name: Vera
    camp: verification
    relation: "Same camp, different layer of the same idea. Vera proves contracts at the function level via Z3; NanoLang proves the language's core type system itself, from below, via Coq. Vera's <code>&lt;Inference&gt;</code> effect has no NanoLang analogue."
  - slug: aver
    name: Aver
    camp: verification
    relation: "Same-camp neighbour on the ship-the-verification-artefacts axis. Aver exports per-function proofs to Lean 4 and Dafny; NanoLang ships its proofs alongside the source as Coq, zero axioms, 193 theorems."
  - slug: magpie
    name: Magpie
    camp: syntactic
    relation: "Cross-camp foil on the syntactic axis. Magpie strips ambiguity via SSA-as-surface; NanoLang reduces it via prefix-call disambiguation, mandatory annotations, and one canonical form. Different mechanisms for the same diagnosis."
  - slug: nerd
    name: NERD
    camp: syntactic
    relation: "Syntactic-camp direction without the formalism. NERD ships a token-friendly surface and no type system; NanoLang ships Coq proofs. The contrast clarifies what 'unambiguous syntax' costs to back up."
---
