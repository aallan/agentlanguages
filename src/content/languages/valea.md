...
camp: unclassified
spans_camps: []
one_liner: "An AI-native systems programming language announced on Hacker News in March 2026. The Rust MVP compiler ships JSON diagnostics, a JSON AST exporter, a formatter, and a C backend. Public information beyond the repository README is limited."
url: https://github.com/hvoetsch/valea
repo: hvoetsch/valea
paper: null
author: Hans Voetsch (Google)
implementation_language: Rust
compilation_target: C (via the emit-c command)
license: MIT
