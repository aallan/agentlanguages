...
one_liner: "Mandatory contracts on every function. Z3 SMT verification. Typed slot references replace variable names. LLM inference is a first-class typed effect."
...
crossrefs:
  - slug: aver
    name: Aver
    camp: verification
    relation: "Closest design relative. Co-located verify blocks, Lean 4 proof export, decision blocks. Different syntax for the same diagnosis. Now integrated into VeraBench."
  - slug: prove
    name: Prove
    camp: verification
    relation: "Same verification diagnosis, opposite politics. Licence explicitly prohibits AI training use. Refinement types, verb-based IO tracking."
  - slug: ailang
    name: AILANG
    camp: verification
    relation: "Capability-based effects with row polymorphism. Where Vera tracks <code>&lt;Inference&gt;</code> as one effect, AILANG carves it into IO/FS/Net/Clock/AI."
  - slug: magpie
    name: Magpie
    camp: syntactic
    relation: "Cross-camp foil. Magpie strips ambiguity at the surface (SSA form); Vera adds a layer of mechanical checks. Different bets on where the error budget should be spent."
history:
  - when: "Feb 2026"
    what: "First public release (v0.0.4). Grammar, parser, and type checker. No verifier yet."
  - when: "Mar 2026"
    what: "Z3 verifier lands. Three-tier verification scheme published. First externally-contributed example merges."
  - when: "Apr 2026"
    what: "VeraBench published with 93% flagship correctness vs Python baseline on zero training data."
  - when: "Apr 2026"
    what: "<code>&lt;Inference&gt;</code> effect added as first-class typed effect. Aver becomes first external language integrated into VeraBench."
  - when: "May 2026"
    what: "v0.0.157 releases. 300+ stars, 76 conformance programs, 13-chapter spec."
---
