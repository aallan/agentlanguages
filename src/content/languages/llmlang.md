...
one_liner: "Prefix-arity AST with single-character ASCII operators and De Bruijn variable indices. Linear ownership enforced at compile time. Compiler-injected OpenTelemetry spans triggered by a metadata marker. LLVM IR via Rust, OpenCL JIT for GPU map operations."
url: https://github.com/paulprogrammer/llmlang
repo: paulprogrammer/llmlang
paper: null
author: Paul Williams (paulprogrammer)
implementation_language: Rust
compilation_target: LLVM IR (then native via clang); OpenCL JIT for GPU map kernels at runtime
license: GPL-3.0 with Runtime Exception
