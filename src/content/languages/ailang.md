...
camp: verification
spans_camps: []
one_liner: "Row-polymorphic Hindley-Milner with capability-based effects (IO, FS, Net, Clock, AI). No loops, lambda calculus only. Written autonomously by AI agents."
url: https://ailang.sunholo.com
repo: sunholo-data/ailang
paper: null
author: Mark Edmondson / Sunholo
implementation_language: Go
compilation_target: Native binaries, WebAssembly
license: Apache-2.0
...
benchmark:
  label: AILANG Benchmark Dashboard
  url: https://ailang.sunholo.com/docs/benchmarks/performance
crossrefs:
  - slug: vera
    name: Vera
    camp: verification
    relation: "Vera tracks LLM inference as one &lt;Inference&gt; effect; AILANG carves authority into IO, FS, Net, Clock, AI as separate capability categories granted per run."
  - slug: boruna
    name: Boruna
    camp: orchestration
    relation: "Both build capability-based effect systems; Boruna enforces declared effects at the VM, AILANG enforces them at the type system and the CLI capability flag."
  - slug: moonbit
    name: MoonBit
    camp: verification
    relation: "Both ship effect typing on a functional core; MoonBit's effects are conventional and general-purpose, AILANG's are row-polymorphic and carved for agent-relevant authority."
history:
  - when: "Sep 2025"
    what: "First public release on GitHub under Apache-2.0."
  - when: "Jan 2026"
    what: "AILANG reaches v0.6.2; Mark Edmondson publishes the language framing on dev.to."
  - when: "May 2026"
    what: "v0.20.1 ships. 110 releases, 2,958 commits. 33-benchmark dashboard runs across 8 frontier models on every release. MCP server, Claude Code plugin, and Gemini CLI extension all in production."
---
